      ...
      <Card className="gap-4 p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
          ...
          <div className="sm:w-56">
            ...
            <select
              className="border-input bg-background text-foreground w-full rounded-md border px-3 py-1.5 text-sm shadow-sm focus:outline-none focus:ring-1"
            ...
            <div className="overflow-x-auto">
              <Card className="p-0">
                <table className="w-full text-sm">
                    ...
                    <tr className="border-b">
                      ...
                      {data.years.map((year, idx) => (
                        <Fragment key={year.id}>
                          <th
                            className="text-muted-foreground border-l px-4 py-2 text-right text-xs font-normal"
                          >
                            Budget
                          </th>
                          <th
                  ...
                  <tfoot>
                    <TotalsRow categories={data.categories} years={data.years} />
                  </tfoot>
                </table>
              </Card>
            </div>
          ...
          return (
            <Fragment key={yd.yearId}>
              ...
              >
                {hasData ? (
                  <span
                    className={cn(yd.available < 0 && 'text-destructive')}
                  >
    ...
    <tr className="bg-muted/30">
      ...
      {years.map((year, idx) => {
        ...
        return (
          <Fragment key={year.id}>
            <td
              className="border-l px-4 py-3 text-right font-semibold"
            >
