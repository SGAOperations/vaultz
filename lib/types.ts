...
export type Transfer = Omit<PrismaTransfer, 'amount'> & { amount: number };

export type TransferWithCategories = Transfer & {
  fromCategory: CategoryWithDesignation;
  toCategory: CategoryWithDesignation;
  year: Year;
};
